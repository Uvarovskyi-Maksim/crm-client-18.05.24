                        ...
                        <div className="user_modal_right_side">
                            <div className='notice_container'>
                                ...
                                <ul className='notice_block'>
                                    ...
                                    <EditNotice selectedNotice={selectedNotice} handleDeleteNotice={handleDeleteNotice} handleEditNotice={handleEditNotice} editNoticeMode={editNoticeMode} setSelectedNotice={setSelectedNotice} close={closeNoticeEdit}></EditNotice>
                                </ul>
                ...
                <div style={{ display: "block" }} className={`user_modal ${editNoticeMode && selectedNotice ? "show" : ""}`}>
                    ...
                    <form>
                        ...
                        <div className='btn_form_block'>
                            ...
                            <button className='register' style={{ width: "120px" }} type="button" onClick={() => handleDeleteNotice(selectedNotice._id)}>
                                Delete
                            </button>
                        </div>
...
const ClientRegistrationForm = ({
    ...
    const checkContactExists = async (numberPhone) => {
        try {
            ...
            const data = await response.json();
            console.log(data.contactExists)
            return data.contactExists;
        } catch (error) {
